...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	privateSubscriptionRepository := repository.NewPrivateSubscriptionRepository(client, db)
	privateSubscriptionService := service.NewPrivateSubscriptionService(privateSubscriptionRepository)
	privateSubscriptionHandler := admin.NewPrivateSubscriptionHandler(privateSubscriptionService)
	businessRepository := repository.NewBusinessRepository(db)
	businessService := service.NewBusinessService(businessRepository)
	businessHandler := admin.NewBusinessHandler(businessService)
	...
	openAIExternalQuotaGateService := service.ProvideOpenAIExternalQuotaGateService(accountRepository, usageLogRepository, openAITokenProvider, gatewayCache, concurrencyService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, privateSubscriptionHandler, businessHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, openAIExternalQuotaGateService)
	...
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, configConfig, settingService)
	...
	privateSubscriptionReminderService := service.ProvidePrivateSubscriptionReminderService(privateSubscriptionRepository)
	businessSnapshotScheduler := service.ProvideBusinessSnapshotScheduler(businessService)
	businessExchangeRateRefresher := service.ProvideBusinessExchangeRateRefresher(businessService)
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, openAIExternalQuotaGateService, subscriptionExpiryService, privateSubscriptionReminderService, businessSnapshotScheduler, businessExchangeRateRefresher, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner)
