...
func init() {
	...
	// apikeyDescRateMultiplier is the schema descriptor for rate_multiplier field.
	...
	// groupDescDedicatedUnlimited is the schema descriptor for dedicated_unlimited field.
	groupDescDedicatedUnlimited := groupFields[4].Descriptor()
	// group.DefaultDedicatedUnlimited holds the default value on creation for the dedicated_unlimited field.
	group.DefaultDedicatedUnlimited = groupDescDedicatedUnlimited.Default.(bool)
	...
	groupDescConcurrency := groupFields[32].Descriptor()
