...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/session-delivery', label: t('nav.sessionDelivery'), icon: ServerIcon },
    ...
    {
      path: '/admin/business',
      label: t('nav.businessManagement'),
      icon: ChartIcon,
      hideInSimpleMode: true,
      expandOnly: true,
      children: [
        { path: '/admin/business/dashboard', label: t('nav.businessDashboard'), icon: ChartIcon },
        { path: '/admin/private-subscriptions', label: t('nav.privateSubscriptions'), icon: UsersIcon },
        { path: '/admin/business/costs', label: t('nav.businessCosts'), icon: CreditCardIcon },
        { path: '/admin/business/reconciliation', label: t('nav.businessReconciliation'), icon: ShieldIcon },
      ],
    },
