  ...
  admin: {
    ...
    accounts: {
      ...
      externalQuotaGate: {
        ...
        description: 'Temporarily schedules the account only when upstream usage came from outside this system.',
        ...
        externalDelta: 'External usage delta',
        lastCheck: 'Last check',
        leaseUntil: 'Available until',
        failClosedHint: 'The account stays unavailable on check errors, no external usage, local traffic, or lease expiry.',
        disabledHint: 'The gate is disabled and the account remains unschedulable. Re-enabling starts with a fresh baseline.',
        schedulableManaged: 'Schedulability is managed automatically by the external quota gate',
        badgeAvailable: 'Ext. quota on',
        badgeAvailableTitle: 'External usage was detected and the temporary availability lease is active',
        ...
        decisions: {
          ...
          localTraffic: 'Local traffic detected',
