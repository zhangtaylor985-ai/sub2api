  ...
  admin: {
    ...
    accounts: {
      ...
      externalQuotaGate: {
        ...
        description: 'Confirms external usage while closed, then grants a fixed 60-minute availability window.',
        ...
        policyLease: 'Fixed 60-minute grant',
        policyNoRenewal: 'Local traffic cannot renew',
        ...
        failClosedHint: 'Only upstream growth observed while the account is closed and free of local traffic grants a fixed 60-minute window. Local traffic during the grant never renews it.',
        ...
        badgeAvailableTitle: 'External usage was confirmed and the fixed 60-minute availability window is active',
