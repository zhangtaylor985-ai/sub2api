export default {
  ...
  admin: {
    ...
    apiKeys: {
      ...
      concurrentUnits: 'concurrent',
      samePlanQueuedHint: 'The same plan is already active. This purchase starts after its current period and does not duplicate limits now.',
      differentPlanImmediateHint: 'A different plan starts immediately and stacks limits and concurrency while periods overlap.',
      planActive: 'Active',
      planUpcoming: 'Upcoming',
      planExpired: 'Expired',
