export default {
  ...
  admin: {
    ...
    sessionDelivery: {
      title: 'Session Delivery Console',
      description: 'Monitor the complete path from gateway capture and isolated PostgreSQL to hourly archives and verified Google Drive uploads, with global and per-key capture controls.',
      refresh: 'Refresh status',
      refreshing: 'Refreshing',
      lastObserved: 'Last observed',
      loadFailed: 'Failed to load Session delivery status',
      attentionRequired: 'Delivery pipeline needs attention',
      notYet: 'Not archived yet',
      deliverable: 'Deliverable',
      archivedRecords: 'Archived records',
      fullReadbackVerified: 'Uploaded and verified by full SHA readback',
      status: {
        healthy: 'Healthy',
        degraded: 'Degraded',
        critical: 'Critical',
      ...
      pipeline: {
        ...
        online: 'Online',
        unavailable: 'Unavailable',
        exporting: 'Exporting a closed UTC hour',
        failed: 'Export failed',
        working: 'Working',
        scheduled: 'Waiting for close',
        verified: 'Verified',
        waiting: 'Waiting for first archive'
      },
      host: {
      ...
      batches: {
        title: 'Recent archive batches',
        lastTwelve: 'Last 12 batches',
        hour: 'UTC hour',
        status: 'Status',
        records: 'DB records',
        delivery: 'Deliveries',
        ...
        waitingDescription: 'No archive batch is not an error; delivery files are created only after the current hour closes.'
      },
      batchStatus: {
        exporting: 'Exporting',
        archived: 'Uploaded, unverified',
        verified: 'Verified',
        purged: 'Verified and purged',
        failed: 'Failed'
      },
      warnings: {
        policy_summary_unavailable: 'Capture policy summary is unavailable',
        spool_unavailable: 'Gateway spool is unreadable',
        spool_usage_critical: 'Gateway spool usage reached 80%',
        spool_usage_high: 'Gateway spool usage reached 60%',
        spool_quarantine_present: 'The spool contains quarantined records',
        spool_forwarding_delayed: 'Pending forwarding is delayed over 15 minutes',
        remote_status_not_configured: 'Isolated database status channel is not configured',
        remote_status_unavailable: 'Isolated database status channel is unavailable',
        disk_guard_reached: 'Database host disk guard has been reached',
        disk_usage_high: 'Database host disk usage is high',
        archive_batches_failed: 'One or more archive batches failed',
        archive_in_progress: 'An archive job is running'
      },
      policy: {
        title: 'Session capture control',
        description: 'The global mode defines the default; API key rules provide precise overrides. Changes apply only to future requests and never delete history from the database, spool, or Drive.',
        effective: 'API keys being recorded',
        modeAll: 'Record all',
        modeAllDescription: 'Record every API key by default, with optional per-key exclusions.',
        modeSelected: 'Record selected keys',
        modeSelectedDescription: 'Record nothing by default; only explicitly included keys are captured.',
        modeDisabled: 'Pause all capture',
        modeDisabledDescription: 'Stop all new Session capture immediately while preserving history.',
        futureOnly: 'Policy changes affect future requests only. Pausing or excluding never deletes saved, pending, or uploaded Sessions.',
        searchPlaceholder: 'Search by key name, ID, or user email',
        recording: 'Recording',
        ...
        onlyThisKey: 'Only this key',
        noKeys: 'No matching API keys',
        pagination: 'Page {page} / {pages}, {total} keys total',
        confirmModeTitle: 'Switch to “{mode}”?',
        confirmMode_all: 'Resume capture for all API keys while preserving per-key exclusions.',
        confirmMode_selected: 'Only API keys explicitly set to “Always record” will create new Session records.',
        confirmMode_disabled: 'All API keys will stop creating new Session records immediately. Existing history is preserved.',
        onlyConfirmTitle: 'Record only this API key?',
        onlyConfirmMessage: 'Switch to selected mode, clear every other key override, and keep only #{id} {name}.',
        apply: 'Apply policy',
        saved: 'Session capture policy updated',
        saveFailed: 'Failed to update Session capture policy',
        loadFailed: 'Failed to load API key capture policy'
      }
    },
