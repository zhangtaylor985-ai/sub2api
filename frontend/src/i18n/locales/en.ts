export default {
  ...
  keyUsage: {
    ...
    stackedPlans: 'Stacked Plans',
    stackedPlansTitle: '{count} plans are currently active',
    stackedPlansHint: 'Each plan has its own period. Its daily, weekly, and concurrency contribution is removed automatically when it expires.',
    overallExpiry: 'Overall API key expiry',
    effectiveDailyLimit: 'Effective daily limit',
    effectiveWeeklyLimit: 'Effective weekly limit',
    effectiveConcurrency: 'Effective concurrency',
    planActive: 'Active',
    planUpcoming: 'Upcoming',
    planExpired: 'Expired',
    concurrentUnits: 'concurrent',
    packageTotal: 'Package Total',
    packageUsed: 'Package Used',
    packageRemaining: 'Package Remaining',
    packageRangeUsed: 'Package Paid in Range',
    packageHint: 'After daily or weekly limits are used, overage is paid from token packages as needed',
    packageRecentCount: 'Recent {count}',
    packageUsedPct: '{pct}% used',
    packageRecentUsage: 'Recent Package Usage',
    packagePaid: 'Package Paid',
  ...
  keys: {
    ...
    expirationRequiredHint: 'Every API key must expire; new keys default to 30 days.',
    expirationRequired: 'Please set an API key expiration time',
    expirationInvalid: 'Invalid expiration time',
    expirationFutureRequired: 'Expiration must be in the future',
  ...
  admin: {
    ...
    apiKeys: {
      ...
      addPlanPackage: 'Stack Plan',
      confirmPlanPackage: 'Confirm Plan',
      currentExpiry: 'Current overall expiry',
      effectiveDailyLimit: 'Effective daily limit',
      effectiveWeeklyLimit: 'Effective weekly limit',
      effectiveConcurrency: 'Effective concurrency',
      planPackageHistory: 'Plan periods and status',
      planPeriod: 'Service period',
      planContribution: 'Contribution (daily / weekly / concurrency)',
      concurrentUnits: 'concurrent',
      samePlanImmediateHint: 'The same plan is already active. This purchase stacks limits and concurrency immediately, while extending the latest expiry.',
      planImmediateHint: 'This plan starts immediately and stacks limits and concurrency while periods overlap.',
      planActive: 'Active',
      planUpcoming: 'Upcoming',
      planExpired: 'Expired',
      planPackageAdded: 'Plan package added',
      planPackageAlreadyAdded: 'This plan purchase was already processed',
      allStatus: 'All Status',
      allGroups: 'All Groups',
      ungrouped: 'No Group',
      ...
      resetDailyWindow: 'Reset daily limit',
      resetWeeklyWindow: 'Reset weekly limit',
      resettingWindow: 'Resetting...',
      currentDailyUsage: 'Daily usage ${used}',
      currentWeeklyUsage: 'Weekly usage ${used}',
      confirmDailyReset: 'Reset the daily limit for API key "{name}"? The current daily usage of ${used} will be cleared while the window continues to reset naturally at 00:00 Beijing time. The 5-hour and weekly windows will not change.',
      confirmWeeklyReset: 'Reset the weekly limit for API key "{name}"? The current weekly usage of ${used} will be cleared and a new 7-day period will start now, ending around {end}. The daily and 5-hour windows will not change.',
      dailyWindowResetSuccess: 'Daily limit reset',
      weeklyWindowResetSuccess: 'Weekly limit restarted from the current time',
      ...
      form: {
        ...
        dispatchOverrideHint: 'Leave empty to inherit the group and then global config. Enter gpt-5.4 or gpt-5.6-sol to override only this API key for Claude /v1/messages dispatch to OpenAI/Codex.',
        allowFable5: 'Allow Claude Fable 5',
        allowFable5Hint: 'When enabled, only this API key may request claude-fable-5, mapped to gpt-5.4 by default.',
        opusMappedModel: 'Opus target model',
        sonnetMappedModel: 'Sonnet target model',
        haikuMappedModel: 'Haiku target model',
        expiresAt: 'Expires At',
        expiresInDays: '{days} days',
        expirationRequiredHint: 'Required; new API keys expire in 30 days by default.',
        ...
        resetRateUsage: 'Reset all rate-limit windows (5-hour / daily / weekly)',
        ...
        planPackage: 'Vehicle plan',
        planMonths: 'Months',
        planNote: 'Payment note',
        planNotePlaceholder: 'e.g. WeChat payment on Aug 22'
      },
      errors: {
        ...
        loadPlanPackagesFailed: 'Failed to load plan periods',
        addPlanPackageFailed: 'Failed to add plan package',
        invalidPlanPackage: 'Select a valid plan and enter 1–24 months',
        invalidRateMultiplier: 'Speed must be greater than 0',
        expirationRequired: 'Please set an API key expiration time',
        expirationFutureRequired: 'Expiration must be in the future',
        ...
        resetWindowFailed: 'Failed to reset rate-limit window'
      },
      modelAccessClaude: 'Claude',
      modelAccessGPT: 'GPT',
      modelAccessImage: 'Images',
      modelAccessFable: 'Fable 5',
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        allowFable5: 'Enable Claude Fable 5 for this group',
        allowFable5Hint: 'When enabled, API keys in this OpenAI group without their own override may request claude-fable-5, mapped to gpt-5.4 by default.',
        familyMappingTitle: 'Family Default Mapping',
        familyMappingHint: 'Requests matching the Opus, Sonnet, or Haiku families prefer the target configured here. Leave empty to inherit the global default.',
        opusModel: 'Opus Target Model',
        opusModelPlaceholder: 'Inherit global, e.g. gpt-5.6-sol',
        sonnetModel: 'Sonnet Target Model',
        sonnetModelPlaceholder: 'Inherit global, e.g. gpt-5.6-sol',
        haikuModel: 'Haiku Target Model',
        haikuModelPlaceholder: 'Leave empty for gpt-5.4-mini',
    ...
    accounts: {
      ...
      externalQuotaGate: {
        title: 'External Quota Gate',
        description: 'Opens after confirmed external usage, then safely drains existing sessions before closing.',
        enable: 'Enable external quota gate',
        disable: 'Disable external quota gate',
        available: 'Available now',
        unavailable: 'Unavailable now',
        drainingOnly: 'Draining · existing sessions only',
        refresh: 'Check now',
        refreshing: 'Checking...',
        policyInterval: 'Checks every minute',
        policyLease: 'Opens for {minutes} minutes',
        policyDrain: 'Existing sessions drain safely at expiry',
        grantMinutes: 'Availability after detection (minutes)',
        grantMinutesHint: 'Configurable per account from 30–720 minutes. Changes apply to the next grant and do not alter the current deadline.',
        savePolicy: 'Save duration',
        policySaved: 'Availability duration saved',
        primaryUsage: 'Upstream primary usage',
        observationBaseline: 'Closed observation baseline',
        externalDelta: 'Last confirmed external delta',
        lastCheck: 'Last check',
        externalDetectedAt: 'Last external confirmation',
        leaseUntil: 'Current/last grant until',
        activeStickySessions: 'Active sticky bindings',
        inflightAndWaiting: 'In flight / waiting',
        drainProgress: 'Drain confirmation',
        drainChecks: 'Consecutive empty checks {current}/{required}',
        stickyCountShort: '{count} sticky',
        recentEvents: 'Recent state changes',
        failClosedHint: 'At the availability deadline, new sessions stop entering while existing sticky sessions stay on the same account. The account closes only after sticky, in-flight, and waiting counts are all zero for two consecutive checks.',
        disabledHint: 'The gate is disabled and the account remains unschedulable. Re-enabling starts with a two-minute quiet observation and a fresh baseline.',
        schedulableManaged: 'Schedulability is managed automatically by the external quota gate',
        badgeAvailable: 'Ext. quota on',
        badgeAvailableTitle: 'External usage was confirmed and the configured availability or safe-drain window is active',
        badgeDraining: 'Ext. quota drain',
        badgeDrainingTitle: 'New sessions are blocked while {count} active sticky bindings drain',
        badgeUnavailable: 'Ext. quota off',
        badgeUnavailableTitle: 'The external quota gate is enabled and scheduling is currently blocked',
        badgeError: 'Ext. quota error',
        badgeErrorTitle: 'The quota check failed and the account remains unavailable',
        enabledSuccess: 'External quota gate enabled and initial check completed',
        disabledSuccess: 'External quota gate disabled and account made unavailable',
        refreshedSuccess: 'External quota status refreshed',
        updateFailed: 'Failed to update external quota gate',
        refreshFailed: 'Failed to refresh external quota status',
        decisions: {
          initializing: 'Waiting for first check',
          externalDecrease: 'External usage detected',
          leaseActive: 'External usage lease active',
          leaseActiveUpstreamError: 'Upstream check failed; original grant remains active',
          drainingStarted: 'Grant expired; draining existing sessions',
          draining: 'Draining existing sessions',
          drainingWithoutLease: 'No valid grant; draining safely',
          drainingWindowChanged: 'Quota window changed; draining safely',
          drainingUpstreamError: 'Upstream check failed; safe drain continues',
          drainingCheckError: 'Drain check failed; account will not close',
          drainComplete: 'Existing sessions drained; account closed',
          upstreamUnavailable: 'Upstream quota unavailable',
          baselineCreated: 'Detection baseline created',
          observingExternalUsage: 'Observing for external usage',
          observationCooldown: 'Waiting for local traffic to drain',
          noExternalDecrease: 'No external usage detected',
          localTraffic: 'Local traffic detected; baseline restarted',
          leaseExpired: 'External usage lease expired',
          windowChanged: 'Quota window changed',
          inactiveLeaseDiscarded: 'Stale lease discarded',
          schedulableWithoutLeaseClosed: 'Closed because no valid grant exists',
          invalidAccount: 'Account state is not eligible',
          upstreamError: 'Upstream quota check failed',
          localUsageError: 'Local usage check failed',
    ...
    usage: {
      ...
      searchApiKeyPlaceholder: 'Search by name or API key...',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiMessagesDispatchDefaultTarget: 'Global Claude → GPT Target',
        openaiMessagesDispatchDefaultTargetHint: 'Applies to Opus and Sonnet requests in OpenAI groups when no API-key or group override exists. Precedence: API key > group > this global setting. Haiku continues to default to gpt-5.4-mini.',
      },
      webSearchEmulation: {
