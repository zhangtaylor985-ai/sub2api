export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      externalQuotaGate: {
        title: '外部额度闸门',
        description: '账号关闭期间确认外部消耗后，固定放行 60 分钟。',
        enable: '启用外部额度闸门',
        disable: '关闭外部额度闸门',
        available: '当前可用',
        unavailable: '当前不可用',
        ...
        policyLease: '确认后固定放行 60 分钟',
        policyNoRenewal: '本站流量不续期',
        ...
        recentEvents: '最近状态变化',
        failClosedHint: '只有账号关闭且观察区间无本站请求时，上游用量增长才会触发固定 60 分钟放行；放行期间的本站流量不会续期。',
        disabledHint: '闸门已关闭，账号保持不可调度；重新启用后会先经过 2 分钟安静观察并建立基线。',
        schedulableManaged: '该账号的可调度状态由外部额度闸门自动管理',
        badgeAvailable: '外额放行',
        badgeAvailableTitle: '已确认外部额度消耗，当前处于固定 60 分钟放行期',
